...
const api = {
  ...
  getInvoice: (currentAppointment) => {
    return axios.get(
      `${baseUrl}/patient/appointments/${currentAppointment?._id}/getInvoice`
    );
  },
  ...
  prescriptions: (patientEmail) => {
    return axios.get(`${baseUrl}/patient/${patientEmail}/prescriptions`);
  },
